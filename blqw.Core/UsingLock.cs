...
namespace blqw
{
    ...
    public class UsingLock : Disposable, IDisposable
    {
        ...
        {
            Enabled = true;
            base.DisposeManaged += _lockSlim.Dispose;
        }

        public bool IsReadLocked { get { return _lockSlim.IsReadLockHeld; } }
        public bool IsWriteLocked { get { return _lockSlim.IsWriteLockHeld; } }
